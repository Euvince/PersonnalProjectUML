<div class="row" x-data = "{ chambresChecked : @entangle('chambresChecked').defer }">
    ...
    <div class="col-12 mt-5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="d-flex justify-content-center">
                                                    <li class="mr-3"><a href="{{ route('admin.chambres.show', ['chambre' => $chambre->id]) }}" class="text-primary"><i class="fa-solid fa-eye"></i></a></li>
        ...
        @else <h5 class="mt-2"><strong>Aucune chambre disponible</strong></h5>
        @endif
    </div>
    <div class="ml-4 mt-4">
        {{ $chambres->links() }}
